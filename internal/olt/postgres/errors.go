...
// covers. All three map to apperror.KindConflict for the same reasoning
// given throughout this codebase: the request conflicts with the
// current relational state of the data.
//
