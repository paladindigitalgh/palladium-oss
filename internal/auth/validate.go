...
import "github.com/paladindigitalgh/palladium-oss/internal/platform/validate"

// Validate reports whether u has every required field set: a present,
// correctly shaped Email, and a non-empty PasswordHash (present "when
...
// gone through HashPassword, never before). It cannot verify PasswordHash
// was actually produced by HashPassword — that is a property of how the
// value was constructed, not something the shape of the string reveals.
